                ...
                <div  id="cc">
                    ...
                    <div class="row">
                        <div id="group1"  class="col-md-4">
                            ...
                            <input id="ch8"  type="text"  name="one"   maxlength="1" size="1">
                            <input id="ch8"  type="text"  name="two"   maxlength="1" size="1">
                            <input id="ch8" type="text"  name="three"   maxlength="1"size="1">
                            <input id="ch8" type="text"  name="four"   maxlength="1" size="1">
                        </div>
                        <div id="group1"  class="col-md-4">

                            <input id="ch8" type="text"  name="five"   maxlength="1" size="1">
                            <input id="ch8" type="text"  name="six"   maxlength="1"  size="1">
                       </div>
                       <div id="group1"   class="col-md-4">

                            <input id="ch8"  type="text"  name="seven"   maxlength="1" size="1">
                            <input id="ch8"  type="text"  name="eaght"   maxlength="1" size="1">
                            <input id="ch8" type="text"  name="nine"   maxlength="1"size="1">
                            <input id="ch8" type="text"  name="ten"   maxlength="1" size="1">
                            <input id="ch8" type="text"  name="eleven"   maxlength="1" size="1">        
                        </div>    
